...
@section('page-title')
    <title>{{ config('constants.page_title.email_edit') }}</title>
@endsection
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.notify.email.update', $email) }}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-4 form-group">
                                ...
                                <input value="{{ old('subject', $email->subject) }}" type="text" name="subject"
                            ...
                            <section class="col-12 col-md-4 form-group">
                                ...
                                <input value="{{ old('published_at', $email->published_at) }}" type="text"
                                    name="published_at" id="published_at" class="d-none form-control form-control-sm">
                                <input value="{{ old('published_at', $email->published_at) }}" type="text"
                                    name="" id="published_at_view" class="form-control form-control-sm">
