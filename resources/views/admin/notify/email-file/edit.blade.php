...
@section('page-title')
    <title>{{ config('constants.page_title.email_file_edit') }}</title>
@endsection
                        ...
                        <section class="row">
                            ...
                            <section class="col-12  form-group">
                                ...
                                <select name="file_location" id="file_location" class="form-control form-control-sm">
                                    <option value="1" @if (old('file_location', $file->file_location) == 1) selected @endif >ذخیره در Public</option>
                                    <option value="2" @if (old('file_location', $file->file_location) == 2) selected @endif>ذخیره در Storage</option>
                                </select>
                            </section>
