...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد صفحه</li>
        </ol>
    </nav>
                    ...
                    <form action="{{ route('admin.content.page.store') }}" method="post">
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 form-group">
                                ...
                                <input value="{{ old('title') }}" type="text" name="title" id="title" class="form-control form-control-sm">
                                @error('title')
