                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                ...
                                <td class="text-left">
                                    ...
                                    <a href="{{ route('admin.market.order.detail', $order) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-book"></i> جزئیات سفارش
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                <th>نام مشتری</th>
                                <td class="text-left font-weight-bolder">{{ $order->user->full_name ?? '-' }}</td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                <th>پلاک</th>
                                <td class="text-left font-weight-bolder">{{ $order->address->number ?? '-' }}</td>
                            </tr>

                            <tr class="border-bottom">
                                <th>نام گیرنده</th>
                                <td class="text-left font-weight-bolder">{{ $order->address->recipient_firstname ?? '-' }}
                                </td>
                            </tr>

                            <tr class="border-bottom">
                                <th>نام خانوادگی گیرنده</th>
                                <td class="text-left font-weight-bolder">{{ $order->address->recipient_lastname ?? '-' }}
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                <th>تاریخ ارسال</th>
                                <td class="text-left font-weight-bolder">{{ jalali_date($order->delivery_date) ?? '-' }}
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ digitGroup($order->order_final_amount) ?? '-' }}</td>
                            </tr>

                            <tr class="border-bottom">
                                <th>مجموع مبلغ تخفیفات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ digitGroup($order->order_discount_amount) ?? '-' }}</td>
                            </tr>

                            <tr class="border-bottom">
                                <th>مبلغ تخفیف همه محصولات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ digitGroup($order->order_total_products_discount_amount) ?? '-' }}</td>
                            </tr>

                            <tr class="border-bottom">
                                <th>مبلغ نهایی</th>
                                <td class="text-left font-weight-bolder">
                                    {{ digitGroup($order->order_final_amount - $order->order_discount_amount) ?? '-' }}
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                <th>بانک</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->payment->paymentable->gateway ?? '-' }}</td>
                            </tr>


                            <tr class="border-bottom">
                                <th>کوپن استفاده شد</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->copan->code ?? '-' }}</td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_copan_discount_amount ?? '-' }}</td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_common_discount_amount ?? '-' }}</td>
                            </tr>
