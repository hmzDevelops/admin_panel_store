        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3">
                    <div>
                        <a href="{{ route('admin.market.guarantee.create', $product) }}" class="btn btn-info btn-sm">ایجاد گارانتی
                            جدید</a>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2">گارانتی کالا</th>
                        ...
                        <tbody>
                            @foreach ($product->guarantees as $guarantee)
                                <tr>
                                    ...
                                    <td>{{  digitGroup($guarantee->price_increase) }}</td>
                                    <td class="width-16-rem text-center">

                                        <form class="d-inline"
                                            action="{{ route('admin.market.guarantee.destroy', ['product' => $product, 'guarantee' => $guarantee]) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
