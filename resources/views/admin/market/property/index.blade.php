                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2">واحد اندازه گیری</th>
                                <th class="col-md-2">فرم والد</th>
                            ...
                            @foreach ($category_attributes as $category_attribute)
                                <tr>
                                    ...
                                    <td class="width-16-rem text-center">
                                        <a href="{{ route('admin.market.value.index', $category_attribute) }}"
                                        ...
                                        <a href="{{ route('admin.market.property.edit', $category_attribute) }}"
                                            ...
                                            ویرایش</a>
                                        <form class="d-inline"
                                            action="{{ route('admin.market.property.destroy', ['category_attribute' => $category_attribute]) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
