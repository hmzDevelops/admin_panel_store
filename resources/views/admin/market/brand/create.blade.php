                    ...
                    <form id="form" action="{{ route('admin.market.brand.store') }}" method="post"  enctype="multipart/form-data">
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 form-group">
                                <label for="orginal_name">نام اصلی برند</label>
                                <input type="text" name="orginal_name" id="orginal_name" value="{{ old('orginal_name') }}"
                            ...
                            <section class="col-12 col-md-6 form-group">
                                <label class="font-weight-bold" for="logo">تصویر</label>
