            ...
            <section class="main-body-container">
                ...
                <section class="card mb-3">
                    ...
                    <section class="card-body">
                        ...
                        <p class="card-text">بانک : {{ $payment->paymentable->gateway ?? 'null' }}</p>
                        <p class="card-text">شماره پرداخت: {{ $payment->paymentable->transaction_id ?? 'null' }}</p>
                        <p class="card-text">تاریخ پرداخت: {{ jalali_date($payment->paymentable->pay_date) ?? 'null' }}</p>
                        <p class="card-text">دریافت کننده : {{ $payment->paymentable->cash_reciver ?? 'null' }}</p>
                    </section>
                </section>
            </section>
        </section>
