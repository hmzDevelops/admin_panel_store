...
@section('page-title')
    <title>{{ config('constants.page_title.ticket_priority_create') }}</title>
@endsection
...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد اولویت بندی </li>
        </ol>
    </nav>
                    ...
                    <form action="{{ route('admin.ticket.priority.store') }}" method="post">
                        ...
                        <section class="row">
                            ...
                            <section class="col-6 form-group">
                                <label class="font-weight-bold" for="name">نام اولویت</label>
