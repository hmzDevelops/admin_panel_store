...
@section('page-title')
    <title>{{ config('constants.page_title.ticket_category_edit') }}</title>
@endsection
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.ticket.category.update', $ticketCategory) }}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <section class="row">
                            ...
                            <section class="col-6 form-group">
                                ...
                                <input value="{{ old('name', $ticketCategory->name) }}" type="text" name="name" id="name" class="form-control form-control-sm">
                                @error('name')
