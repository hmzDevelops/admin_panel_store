        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3">
                    <div>
                        <a href="#" class="btn btn-info btn-sm disabled">ایجاد
                            تنظیمات جدید </a>
                        <a href="{{ route('admin.setting.refresh') }}" class="btn btn-dark btn-sm">
                             بازنشانی جدول ها</a>
                    </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img width="60" height="60" src="{{ asset($setting->logo) }}" alt="image">
                                </td>
                                <td><img width="60" height="60" src="{{ asset($setting->icon) }}" alt="image">
                                </td>
